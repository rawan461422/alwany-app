...
public class UserAppHelperAdapter extends RecyclerView.Adapter<UserAppHelperAdapter.helper>{
    ...
    public UserAppHelperAdapter(ArrayList<HelperAppsDataClass> arrayList, Context context) {
