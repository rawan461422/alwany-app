...
public class UserHospitalAdapter extends RecyclerView.Adapter<UserHospitalAdapter.helper>{
    ...
    public UserHospitalAdapter(ArrayList<HospitalDataClass> arrayList, Context context) {
    ...
    public helper onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_user_hospital,parent,false);
