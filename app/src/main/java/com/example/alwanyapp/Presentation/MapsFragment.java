package com.example.alwanyapp.Presentation;
...
public class MapsFragment extends Fragment {
    ...
    private OnMapReadyCallback callback = new OnMapReadyCallback() {
        ...
        public void onMapReady(GoogleMap googleMap) {
            LatLng Riyadh = new LatLng(24.73988, 46.684485);
            googleMap.addMarker(new MarkerOptions().position(Riyadh).title("Marker in Riyadh"));
            googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Riyadh,12));
    ...
    private void notifyLocation(LatLng latLng) {
        ...
        pDialogSuccess.setTitleText("هل تريد اختيار هذا الموقع");
        pDialogSuccess.setConfirmText("نعم");
        pDialogSuccess.setCancelText("لا");
