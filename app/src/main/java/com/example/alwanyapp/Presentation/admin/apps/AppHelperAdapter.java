...
public class AppHelperAdapter extends RecyclerView.Adapter<AppHelperAdapter.helper>{
    ...
    public AppHelperAdapter(ArrayList<HelperAppsDataClass> arrayList, Context context) {
    ...
    public helper onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_admin_apps_helper,parent,false);
    ...
    public class helper extends RecyclerView.ViewHolder{
        ...
        public helper(@NonNull View itemView) {
            super(itemView);
            name=itemView.findViewById(com.example.alwanyapp.R.id.name);
            image =itemView.findViewById(com.example.alwanyapp.R.id.image);
        }
    }
}
