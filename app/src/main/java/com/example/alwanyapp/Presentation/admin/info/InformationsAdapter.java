...
public class InformationsAdapter extends RecyclerView.Adapter<InformationsAdapter.helper>{
    ...
    public InformationsAdapter(ArrayList<InfoDataClass> arrayList, Context context) {
    ...
    public helper onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_info_adapter,parent,false);
